...
class NeighbourManager{
    ...
    func createRegionForCurrentNeighbourhood(){
        ...
        let predicate = NSPredicate(format: "neighbourhood.name == %@", (currentNeighbour?.name)!)
    ...
    func setCurrentNeighbourWithName(name: String){
        currentNeighbour = fetchNeighbourhood(name)
        createRegionForCurrentNeighbourhood()
    }
    
    func setCurrentNeighbourWithObject(neighbour: Neighbourhood){
